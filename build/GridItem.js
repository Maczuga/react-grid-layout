...
var GridItem = (function(_React$Component) {
  ...
  GridItem.prototype.calcXY = function calcXY(top, left) {
    ...
    var y = Math.round((top - margin[1]) / rowHeight);
  ...
  GridItem.prototype.mixinDraggable = function mixinDraggable(
    child,
    isDraggable
  ) {
  ...
  GridItem.prototype.mixinResizable = function mixinResizable(
    child,
    position,
    isResizable
  ) {
