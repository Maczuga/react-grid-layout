        ...
        (e.getViewportSize = function(t) {
          ...
          if ("vw" === t)
            return (
              ...
              window && window.innerWidth && (n = window.innerWidth),
              Math.max(e, n)
            );
          if ("vh" === t)
            return (
              ...
              window && window.innerHeight && (o = window.innerHeight),
              Math.max(r, o)
            );
          return 0;
        }),
        (e.isUnitRelative = function(t) {
          switch (t) {
            case "vw":
            case "vh":
              return !0;
        ...
        (e.synchronizeLayoutWithChildren = function(t, e, n, o) {
          ...
          return (
            a.default.Children.forEach(e, function(e, n) {
              ...
              if (
                o &&
                void 0 === e.props["data-grid"] &&
                void 0 === e.props._grid
              )
                i[n] = c(o);
              else {
                !s &&
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        (k["[object Float32Array]"] = k["[object Float64Array]"] = k[
          ...
          (k[u] = k[l] = k[z] = k[p] = k[j] = k[f] = k[h] = k[d] = k[g] = k[
            m
        ...
        var E = "object" == typeof t && t && t.Object === Object && t,
          ...
          M = e && !e.nodeType && e,
          W = M && "object" == typeof n && n && !n.nodeType && n,
          L = W && W.exports === M,
          N = L && E.process,
          H = (function() {
            try {
        ...
        function Pt(t) {
          return (
            !(!$t(t) || ((e = t), Q && Q in e)) && (Xt(t) ? tt : D).test(qt(t))
          );
          var e;
        }
        function Mt(t) {
        ...
        var Kt = A
          ...
          : function(t) {
              return Jt(t) && Gt(t.length) && !!k[kt(t)];
            };
        function Qt(t) {
          return null != (e = t) && Gt(e.length) && !Xt(e) ? Dt(t) : Mt(t);
          var e;
        }
        ...
        return (
          ...
          (e.prototype.UNSAFE_componentWillReceiveProps = function(t) {
            ...
            if (
              ...
              (0, i.default)(t.layout, this.state.layout)
          ...
          (e.prototype.onDrag = function(t, e, n, r) {
            ...
            if (c) {
              var p = { w: c.w, h: c.h, x: c.x, y: c.y, placeholder: !0, i: t };
              (s = (0, u.moveElement)(
                s,
                c,
                e,
...
*/
	...
	*/
            ...
            function r() {
              ...
              return (
                ...
                (o.handleDragStart = function(e) {
                  ...
                  if (
                    ...
                    if (null != i) {
                      ...
                      !1 !== c &&
                        (o.props.enableUserSelectHack && V(r),
                        o.setState({ dragging: !0, lastX: s, lastY: u }),
                        I(r, nt.move, o.handleDrag),
                        I(r, nt.stop, o.handleDragStop));
                    }
                  }
                }),
                (o.handleDrag = function(t) {
                  "touchmove" === t.type && t.preventDefault();
                  var e = K(t, o.state.touchIdentifier, o);
                  if (null != e) {
                    var n = e.x,
                      r = e.y;
                ...
                (o.handleDragStop = function(e) {
                  if (o.state.dragging) {
                    var n = K(e, o.state.touchIdentifier, o);
                    if (null != n) {
                      var r = n.x,
                        a = n.y,
                        i = Q(o, r, a),
                        s = t.findDOMNode(o);
                      s && o.props.enableUserSelectHack && X(s.ownerDocument),
                        o.setState({ dragging: !1, lastX: NaN, lastY: NaN }),
                        o.props.onStop(e, i),
                        s &&
                          (B(s.ownerDocument, nt.move, o.handleDrag),
                          B(s.ownerDocument, nt.stop, o.handleDragStop));
                    }
                  }
                }),
                (o.onMouseDown = function(t) {
                  return (nt = et.mouse), o.handleDragStart(t);
                }),
                (o.onMouseUp = function(t) {
                  return (nt = et.mouse), o.handleDragStop(t);
                }),
                (o.onTouchStart = function(t) {
                  return (nt = et.touch), o.handleDragStart(t);
                }),
                (o.onTouchEnd = function(t) {
                  return (nt = et.touch), o.handleDragStop(t);
                }),
                W(o, n)
              );
            }
              ...
              E(r, [
                {
                  ...
                  value: function() {
                    ...
                    if (e) {
                      ...
                      B(n, et.mouse.move, this.handleDrag),
            ...
            E(r, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  var p = this.props,
                    f = p.defaultClassName,
                    h = p.defaultClassNameDragging,
                    d = p.defaultClassNameDragged,
                    y = e.Children.only(this.props.children),
                    g = x(
                      y.props.className || "",
                      f,
                      (T((t = {}), h, this.state.dragging),
                      T(t, d, this.state.dragged),
                      t)
                    );
        ...
        return (
          (ot.displayName = "Draggable"),
          (ot.propTypes = P({}, rt.propTypes, {
          ...
          (ot.defaultProps = P({}, rt.defaultProps, {
            axis: "both",
            bounds: !1,
        ...
        return (
          ...
          (e.prototype.calcColWidth = function() {
            var t = this.props,
              ...
              a = t.unit,
              i = o;
            (0, u.isUnitRelative)(a) &&
              (i = (100 * o) / (0, u.getViewportSize)(a));
            return (i - e[0] * (r - 1) - 2 * n[0]) / r;
          }),
          (e.prototype.calcPosition = function(t, e, n, r, o) {
            var a = this.props,
              ...
              c = a.unit,
              p = this.calcColWidth(),
              f = (0, u.getViewportSize)(c),
              h = {
                left: (p + i[0]) * t + s[0],
                top: (l + i[1]) * e + s[1],
                width: n === 1 / 0 ? n : p * n + Math.max(0, n - 1) * i[0],
                height: r === 1 / 0 ? r : l * r + Math.max(0, r - 1) * i[1]
              };
            return (
              o &&
                o.resizing &&
                ((h.width = o.resizing.width), (h.height = o.resizing.height)),
              o &&
                o.dragging &&
                ((h.top = o.dragging.top),
                (h.left = o.dragging.left),
                (0, u.isUnitRelative)(c) &&
                  ((h.top = (100 * h.top) / f), (h.left = (100 * h.left) / f))),
              h
            );
          }),
          (e.prototype.calcXY = function(t, e) {
            ...
            (0, u.isUnitRelative)(c) &&
              ((e = (100 * e) / f), (t = (100 * t) / f));
            var h = Math.round((e - r[0]) / (p + r[0])),
              d = Math.round((t - r[1]) / (a + r[1]));
            return {
              x: (h = Math.max(Math.min(h, o - i), 0)),
              y: (d = Math.max(Math.min(d, l - s), 0))
            };
          }),
          (e.prototype.calcWH = function(t) {
            var e = t.height,
              ...
              f = Math.round((e + o[1]) / (s + o[1]));
            return {
              w: (p = Math.max(Math.min(p, i - u), 0)),
              h: (f = Math.max(Math.min(f, a - l), 0))
            };
          }),
          (e.prototype.createStyle = function(t) {
            ...
            return (
              e.useCSSTransforms
                ? (o = (0, u.setTransform)(t, this.props.unit))
                : ((o = (0, u.setTopLeft)(t, this.props.unit)),
                  n &&
          ...
          (e.prototype.mixinDraggable = function(t, e) {
            return o.default.createElement(
              i.DraggableCore,
              {
                disabled: !e,
          ...
          (e.prototype.mixinResizable = function(t, e, n) {
            var r = this.props,
              a = r.cols,
              i = r.x,
              l = r.minW,
              ...
              f = r.maxH,
              h = r.unit,
              d = (0, u.getViewportSize)(h),
              y = this.calcPosition(0, 0, a - i, 0).width;
            (0, u.isUnitRelative)(h) && (y = (y * d) / 100);
            var g = this.calcPosition(0, 0, l, c);
            (0, u.isUnitRelative)(h) &&
              ((g.width = (g.width * d) / 100),
              (g.height = (g.height * d) / 100));
            var m = this.calcPosition(0, 0, p, f);
            (0, u.isUnitRelative)(h) &&
              ((m.width = (m.width * d) / 100),
              (m.height = (m.height * d) / 100));
            var v = [g.width, g.height],
              b = [Math.min(m.width, y), Math.min(m.height, 1 / 0)];
            return (
              (0, u.isUnitRelative)(h) &&
                ((e.width = (e.width * d) / 100),
                (e.height = (e.height * d) / 100)),
              o.default.createElement(
                s.Resizable,
                {
            ...
            return function(n, r) {
              ...
              if (i) {
                var s = e.props,
                  ...
                  y = s.minH,
                  g = s.unit,
                  m = (0, u.getViewportSize)(g);
                (0, u.isUnitRelative)(g) &&
                  ((a.width = (100 * a.width) / m),
                  (a.height = (100 * a.height) / m));
                var v = e.calcWH(a),
                  b = v.w,
                  w = v.h;
                (b = Math.min(b, l - c)),
                  (b = Math.max(b, 1)),
                  (b = Math.max(Math.min(b, f), h)),
                  (w = Math.max(Math.min(w, d), y)),
                  e.setState({ resizing: "onResizeStop" === t ? null : a }),
                  i.call(e, p, b, w, { e: n, node: o, size: a });
              }
            };
          }),
          (e.prototype.render = function() {
            ...
            return (
              (h = this.mixinResizable(h, p, u)),
              (h = this.mixinDraggable(h, s))
            );
          }),
          e
        );
    ...
    function(t, e, n) {
          ...
          return (
            ...
            (e.prototype.generateInitialState = function() {
              var t = this.props,
                ...
                i = t.width,
                s = e ? a : i,
                l = (0, u.getBreakpointFromWidth)(n, s),
                c = (0, u.getColsFromBreakpoint)(l, o),
                p =
                  !1 === this.props.verticalCompact
                    ? null
                    : this.props.compactType,
                f = {
                  layout: (0, u.findOrGenerateResponsiveLayout)(
                    r,
                    n,
                    l,
                    l,
              ...
              return this.props.onInit(f), f;
            }),
            (e.prototype.UNSAFE_componentWillReceiveProps = function(t) {
              if (
                t.width === this.props.width &&
                t.viewportWidth === this.props.viewportWidth &&
            ...
            (e.prototype.onWidthChange = function(t) {
              var e = t.breakpointFromViewport,
                n = t.breakpoints,
                r = t.cols,
                o = t.layouts,
                a = t.compactType,
                ...
                p =
                  t.breakpoint ||
                  (0, u.getBreakpointFromWidth)(t.breakpoints, c),
                f = this.state.breakpoint,
                h = (0, u.getColsFromBreakpoint)(p, r);
              if (
                f !== p ||
                this.props.breakpoints !== n ||
                this.props.cols !== r
              ) {
                f in o || (o[f] = (0, s.cloneLayout)(this.state.layout));
                var d = (0, u.findOrGenerateResponsiveLayout)(o, n, p, f, h, a);
                (d = (0, s.synchronizeLayoutWithChildren)(d, t.children, h, a)),
                  (o[p] = d),
                  this.props.onBreakpointChange(p, h),
                  this.props.onLayoutChange(d, o),
                  this.setState({ breakpoint: p, layout: d, cols: h });
              }
      ...
      (h.propTypes = {
        ...
        width: a.default.number.isRequired,
        unit: a.default.string,
        viewportWidth: a.default.number,
        breakpointFromViewport: a.default.bool.isRequired,
      ...
      e.default = function(t) {
        var e = (function(e) {
          function n() {
            ...
            return (
              ...
              (t = r),
              (r.state = { width: 1280, viewportWidth: 1280 }),
              (r.mounted = !1),
              (r.resizeTimeout = null),
              (r.onWindowResize = function(t) {
                var e = r.props.resizeDelay;
              ...
              (r.calculateWidth = function() {
                if (r.mounted) {
                  var t = {},
                    e = i.default.findDOMNode(r);
                  e instanceof HTMLElement && (t.width = e.offsetWidth),
                    r.props.breakpointFromViewport &&
                      "undefined" != typeof window &&
                      (t.viewportWidth = window.innerWidth),
                    Object.keys(t).length && r.setState(t);
                }
              }),
              u(r, t)
            );
        ...
        return (
          (e.defaultProps = {
            ...
            breakpointFromViewport: !1,
            resizeDelay: 0
          }),
          (e.propTypes = {
            measureBeforeMount: a.default.bool,
            breakpointFromViewport: a.default.bool,
            resizeDelay: a.default.number
          }),
          o.default.forwardRef(function(t, n) {
            return o.default.createElement(e, r({}, t, { forwardedRef: n }));
          })
        );
      };
      var o = s(n(0)),
